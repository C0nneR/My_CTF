...
def basic_symbolic_execution():
    ...
    init_state.memory.store(init_state.regs.rsp + 0x10, 772928896, endness = p.arch.memory_endness)
    init_state.memory.store(init_state.regs.rsp + 0x14, pass2, endness = p.arch.memory_endness)
    ...
    sm.explore(find = 0x400a91, avoid = is_bad)
